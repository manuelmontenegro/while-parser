...
yystate(86, [103|Ics], Line, Tlen, Action, Alen) ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
...
yystate(86, [99|Ics], Line, Tlen, Action, Alen) ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [98|Ics], Line, Tlen, Action, Alen) ->
...
yystate(86, [63|Ics], Line, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [61|Ics], Line, Tlen, Action, Alen) ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [60|Ics], Line, Tlen, Action, Alen) ->
...
yystate(86, [38|Ics], Line, Tlen, Action, Alen) ->
...
yystate(86, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [C|Ics], Line, Tlen, Action, Alen) when C >= 106, C =< 109 ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [C|Ics], Line, Tlen, Action, Alen) when C >= 111, C =< 113 ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
yystate(86, [C|Ics], Line, Tlen, Action, Alen) when C >= 120, C =< 122 ->
    yystate(54, Ics, Line, Tlen+1, Action, Alen);
...
yystate(81, Ics, Line, Tlen, _, _) ->
    {40,Tlen,Ics,Line,81};
yystate(80, [38|Ics], Line, Tlen, Action, Alen) ->
...
yystate(71, [101|Ics], Line, Tlen, _, _) ->
    yystate(67, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(69, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
yystate(69, [C|Ics], Line, Tlen, _, _) when C >= 98, C =< 116 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(47, [101|Ics], Line, Tlen, _, _) ->
    yystate(43, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(46, [114|Ics], Line, Tlen, _, _) ->
    yystate(42, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(41, [95|Ics], Line, Tlen, _, _) ->
    yystate(54, Ics, Line, Tlen+1, 35, Tlen);
...
yystate(38, [108|Ics], Line, Tlen, _, _) ->
    yystate(22, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 103 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 105, C =< 107 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
yystate(38, [C|Ics], Line, Tlen, _, _) when C >= 109, C =< 113 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(29, [95|Ics], Line, Tlen, _, _) ->
    yystate(54, Ics, Line, Tlen+1, 39, Tlen);
...
yystate(23, [108|Ics], Line, Tlen, _, _) ->
    yystate(19, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(7, [110|Ics], Line, Tlen, _, _) ->
    yystate(3, Ics, Line, Tlen+1, 40, Tlen);
...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 65, C =< 90 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 97, C =< 106 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 108, C =< 122 ->
    yystate(54, Ics, Line, Tlen+1, 40, Tlen);
